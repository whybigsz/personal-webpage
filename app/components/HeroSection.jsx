      ...
      <div className={` lg:ml-30 xs:ml-0 md:ml-20 sm:ml-10 place-self-start mt-${marginTop} text-left relative`}>
        ...
        <motion.div
          ...
          <div className="flex items-start">
            <Link href="/Ricardo Ferreira.pdf" target="_blank" title="Ricardo Ferreira" className='hover:scale-125 text-blue border-blue-400 flex w-[165px] items-center px-6 py-3 rounded-lg mb-2 border-solid border-2 text-white font-semibold'>
