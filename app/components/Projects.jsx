...
const Projects = () => {
  ...
  className={`place-self-start mt-10 text-left relative`}>
    <h2 className=' text-white mt-20 text-5xl md:text-4xl lg:text-2xl font-extrabold'>
        ...
        <Link href="https://www.github.com/whybigsz" target="_blank" className='hover:scale-125 mt-2 flex w-[140px] items-center px-6 py-3 rounded-lg  border-solid border-2 text-white font-semibold'>
